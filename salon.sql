...
CREATE TABLE public.customers (
    ...
    lastname character varying(26) NOT NULL
);
...
--
-- Name: customers customers_lastname_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.customers
    ADD CONSTRAINT customers_lastname_key UNIQUE (lastname);
